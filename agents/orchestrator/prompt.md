...
Once `dispatches.json` is written, stop immediately. Do not emit a summary, table, or any other text after writing the file — the post-step reads the file directly and the runner exits.
